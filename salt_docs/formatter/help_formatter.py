...
def _print_usage_section():
    """Print usage section."""
    print(f"{HelpColors.LIGHT_GRAY}┌─ {HelpColors.WHITE}{HelpIcons.USAGE} USAGE{HelpColors.RESET}")
    print(f"{HelpColors.LIGHT_GRAY}├─ {HelpColors.MEDIUM_GRAY}{CLI_ENTRY_POINT} [-h] (--repo REPO | --dir DIR) [OPTIONS...]{HelpColors.RESET}")
    print()

def _print_source_section():
    """Print source options section."""
    print(f"{HelpColors.LIGHT_GRAY}┌─ {HelpColors.WHITE}{HelpIcons.SOURCE} SOURCE (Choose One){HelpColors.RESET}")
    print(f"{HelpColors.LIGHT_GRAY}├─ {HelpColors.MEDIUM_GRAY}--repo REPO{HelpColors.DARK_GRAY}           {HelpIcons.INFO} URL of the public GitHub repository{HelpColors.RESET}")
    print(f"{HelpColors.LIGHT_GRAY}└─ {HelpColors.MEDIUM_GRAY}--dir DIR{HelpColors.DARK_GRAY}             {HelpIcons.INFO} Path to local directory{HelpColors.RESET}")
    print()

def _print_options_section():
    """Print options section."""
    print(f"{HelpColors.LIGHT_GRAY}┌─ {HelpColors.WHITE}{HelpIcons.OPTIONS} OPTIONS{HelpColors.RESET}")
    
    options = [
        ("-h, --help", "Show this help message and exit"),
        ("-n, --name NAME", "Project name (optional, derived from repo/directory if omitted)"),
        ("-t, --token TOKEN", "GitHub personal access token (optional, reads from GITHUB_TOKEN env var)"),
        ...
        ("--language LANG", "Language for the generated tutorial (default: from config)"),
        ("--no-cache", "Disable LLM response caching (default: caching enabled)"),
        ("--max-abstractions N", "Maximum number of abstractions to identify (default: from config)")
    ]
    ...
    for i, (option, description) in enumerate(options):
        ...
        print(f"{prefix} {HelpColors.MEDIUM_GRAY}{option:<20}{HelpColors.DARK_GRAY} {HelpIcons.INFO} {description}{HelpColors.RESET}")
    
    print()

def _print_subcommands_section():
    """Print subcommands section."""
    print(f"{HelpColors.LIGHT_GRAY}┌─ {HelpColors.WHITE}{HelpIcons.SUBCOMMANDS} SUBCOMMANDS{HelpColors.RESET}")
    print(f"{HelpColors.LIGHT_GRAY}├─ {HelpColors.MEDIUM_GRAY}init{HelpColors.DARK_GRAY}                  {HelpIcons.INFO} Set up configuration{HelpColors.RESET}")
    print(f"{HelpColors.LIGHT_GRAY}└─ {HelpColors.MEDIUM_GRAY}config <command>{HelpColors.DARK_GRAY}      {HelpIcons.INFO} Manage configuration{HelpColors.RESET}")
    print()

def _print_examples_section():
    """Print examples section."""
    print(f"{HelpColors.LIGHT_GRAY}┌─ {HelpColors.WHITE}{HelpIcons.EXAMPLES} EXAMPLES{HelpColors.RESET}")
...
def _print_more_info_section():
    ...
    print(f"{HelpColors.LIGHT_GRAY}┌─ {HelpColors.WHITE}{HelpIcons.MORE_INFO} MORE INFO{HelpColors.RESET}")
    print(f"{HelpColors.LIGHT_GRAY}└─ {HelpColors.MEDIUM_GRAY}Visit: {HelpColors.WHITE}{HOMEPAGE_URL}{HelpColors.RESET}")
